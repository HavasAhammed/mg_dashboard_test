...
class LeaveDoctorsScreen extends StatefulWidget {
  const LeaveDoctorsScreen({super.key});

  @override
  State<LeaveDoctorsScreen> createState() => _LeaveDoctorsScreenState();
}

class _LeaveDoctorsScreenState extends State<LeaveDoctorsScreen> {
  bool _isVisible = false;
  bool isLoading = false;
  List<LeaveDoctorsModel> dataList = [];
                            ...
                            : dataList.isNotEmpty
                                ? ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      LeaveDoctorsModel model = dataList[index];
  ...
  getData(BuildContext context) async {
    ...
    var data = await DashboardRepo.getLeaveDoctors(jsonData, context);
    if (!data.$1) {
      dataList = data.$2;
    }
    isLoading = false;
