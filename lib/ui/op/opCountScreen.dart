...
import 'package:mg_dashboard/ui/op/opCountDtlScreen.dart';
...
class OpCountScreen extends StatefulWidget {
  const OpCountScreen({super.key});

  @override
  State<OpCountScreen> createState() => _OpCountScreenState();
}

class _OpCountScreenState extends State<OpCountScreen> {
  bool _isVisible = false;
  bool isLoading = false;
  List<OpCountHdrModel> dataList = [];
                            ...
                            : dataList.isNotEmpty
                                ? ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      OpCountHdrModel model = dataList[index];
  ...
  getData(BuildContext context) async {
    ...
    var data = await DashboardRepo.getTotalOpCountHdr(jsonData, context);
    if (!data.$1) {
      dataList = data.$2;
    }
    isLoading = false;
