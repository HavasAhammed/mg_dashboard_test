...
class OpCountDtlScreen extends StatefulWidget {
  OpCountDtlScreen(this.accountId, this.headerName, this.url, {super.key});
  int accountId;
  String headerName;
  String url;

  @override
  State<OpCountDtlScreen> createState() => _OpCountDtlScreenState();
}

class _OpCountDtlScreenState extends State<OpCountDtlScreen> {
  bool _isVisible = false;
  bool isLoading = false;
  List<OpCountDtlModel> dataList = [];
  ...
  getData(BuildContext context) async {
    ...
    var data = await DashboardRepo.getTotalOpCountDetails(
        jsonData, widget.url, context);
    if (!data.$1) {
      dataList = data.$2;
    }
    isLoading = false;
