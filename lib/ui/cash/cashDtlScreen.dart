...
class CashDtlScreen extends StatefulWidget {
  CashDtlScreen(this.accountId, this.headerName, this.url, {super.key});
  int accountId;
  String headerName;
  String url;

  @override
  State<CashDtlScreen> createState() => _CashDtlScreenState();
}

class _CashDtlScreenState extends State<CashDtlScreen> {
  bool _isVisible = false;
  bool isLoading = false;
  List<CashDetailModel> dataList = [];
  ...
  getData(BuildContext context) async {
    ...
    var data =
        await DashboardRepo.getTotalCashDtl(jsonData, widget.url, context);
    if (!data.$1) {
      dataList = data.$2;
    }
    isLoading = false;
