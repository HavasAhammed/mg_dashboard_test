...
class CashHdrScreen extends StatefulWidget {
  const CashHdrScreen({super.key});

  @override
  State<CashHdrScreen> createState() => _CashHdrScreenState();
}

class _CashHdrScreenState extends State<CashHdrScreen> {
  ...
  getData(BuildContext context) async {
    ...
    var data = await DashboardRepo.getTotalCashHdr(jsonData, context);
    if (!data.$1) {
      dataList = data.$2;
    }
    isLoading = false;
