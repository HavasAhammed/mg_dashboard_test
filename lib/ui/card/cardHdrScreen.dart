...
class CardHdrScreen extends StatefulWidget {
  const CardHdrScreen({super.key});

  @override
  State<CardHdrScreen> createState() => _CardHdrScreenState();
}

class _CardHdrScreenState extends State<CardHdrScreen> {
  bool _isVisible = false;
  bool isLoading = false;
  List<CashHdrModel> dataList = [];
  ...
  getData(BuildContext context) async {
    ...
    var data = await DashboardRepo.getTotalCardHdr(jsonData, context);
    if (!data.$1) {
      dataList = data.$2;
    }
    isLoading = false;
