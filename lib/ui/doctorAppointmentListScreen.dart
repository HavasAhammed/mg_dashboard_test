...
class DoctorAppointmentListScreen extends StatefulWidget {
  DoctorAppointmentListScreen(this.doctorName, this.doctorId, {super.key});
  String doctorName;
  int doctorId;
...
class _DoctorAppointmentListScreenState
  ...
  List<AppointmentsModel> dataList = [];
    ...
    var jsonData = jsonEncode({
      "jsonData": {
        "dashDetailModel": {
          ...
          "idAccount": widget.doctorId,
        }
      }
    });

    var data = await DashboardRepo.getDoctorAppointments(jsonData, context);
    if (!data.$1) {
      dataList = data.$2;
    }
    isLoading = false;
