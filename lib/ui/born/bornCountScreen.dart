...
class BornCountScreen extends StatefulWidget {
  const BornCountScreen({super.key});

  @override
  State<BornCountScreen> createState() => _BornCountScreenState();
}

class _BornCountScreenState extends State<BornCountScreen> {
  bool _isVisible = false;
  bool isLoading = false;
  List<BornCountModel> dataList = [];
                            ...
                            : dataList.isNotEmpty
                                ? ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      BornCountModel model = dataList[index];
  ...
  getData(BuildContext context) async {
    ...
    var data = await DashboardRepo.getBornCount(jsonData, context);
    if (!data.$1) {
      dataList = data.$2;
    }
    isLoading = false;
