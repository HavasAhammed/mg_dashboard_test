...
class PaidPatientsScreen extends StatefulWidget {
  const PaidPatientsScreen({super.key});

  @override
  State<PaidPatientsScreen> createState() => _PaidPatientsScreenState();
}

class _PaidPatientsScreenState extends State<PaidPatientsScreen> {
  bool _isVisible = false;
  bool isLoading = false;
  List<PaidPatientModel> dataList = [];
                            ...
                            : dataList.isNotEmpty
                                ? ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      PaidPatientModel model = dataList[index];
  ...
  getData(BuildContext context) async {
    ...
    var data = await DashboardRepo.getPaidPatients(jsonData, context);
    if (!data.$1) {
      dataList = data.$2;
    }
    isLoading = false;
