...
class PharmacyPurchaseScreen extends StatefulWidget {
  const PharmacyPurchaseScreen({super.key});

  @override
  State<PharmacyPurchaseScreen> createState() => _PharmacyPurchaseScreenState();
}

class _PharmacyPurchaseScreenState extends State<PharmacyPurchaseScreen> {
  bool _isVisible = false;
  bool isLoading = false;
  List<PharmacyPurchaseModel> dataList = [];
  ...
  getData(BuildContext context) async {
    ...
    var data = await DashboardRepo.getPharmacyPurchase(jsonData, context);
    if (!data.$1) {
      dataList = data.$2;
    }
    isLoading = false;
