...
class PharmacyAmount extends StatefulWidget {
  ...
  @override
  State<PharmacyAmount> createState() => _PharmacyAmountState();
}

class _PharmacyAmountState extends State<PharmacyAmount> {
